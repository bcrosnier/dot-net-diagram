...
namespace Dot_NET_Diagram
{
    public class DllReader
    {
        ...
        {
            Debug.WriteLine( String.Format( "Recherche de classe mère pour la classe {0}", type.Name ) );
            Debug.Flush();
        ...
        {
            Debug.WriteLine( String.Format( "Récupération des interfaces de la classe {0}", type.Name ) );
            Debug.Flush();
